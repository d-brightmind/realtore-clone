    ...
    <>
      <section className="max-w-6xl mx-auto flex justify-center items-center flex-col">
        ...
        <div className="w-full md:w-[50%] mt-6 px-3">
          <form action="">
            {/*Name Input*/}
            <input className='w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out' disabled type="text" id="name" value={name} onChange={(e) => setFormData((prevState) => ({
              ...prevState,
              name: e.target.value
            }))} />
            
            {/*Email Input*/}
            <input className='w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out mt-6' disabled type="email" id="email" value={email} onChange={(e) => setFormData((prevState) => ({
              ...prevState,
